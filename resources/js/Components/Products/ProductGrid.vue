<template>
    ...
    <div class="flex items-center justify-between py-3 mb-4">
        <div>
            <span class="text-sm font-medium text-surface-600">
                Знайдено <span class="font-bold text-surface-900">{{ productCount }}</span> товарів
            </span>
        </div>
    ...
    <!-- Empty state -->
    <div v-if="!products?.length" class="py-24 flex flex-col items-center justify-center text-center">
