        ...
        <div class="relative z-10 container-app py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
                ...
                <div class="lg:col-span-4">
                    <Link :href="route('home')" class="flex items-center gap-2.5 mb-6 w-fit group">
                ...
                <div class="lg:col-span-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <a
                            href="mailto:hello@techstore.ua"
                            class="flex items-start gap-3 group"
                        >
            ...
            <div class="container-app py-6">
                <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                    ...
                    <p class="text-xs text-surface-500 text-center lg:text-left order-2 lg:order-1">
                        ...
                        <Link :href="'#'" class="hover:text-brand-400 transition-colors">Політика конфіденційності</Link>
                        <span>·</span>
                        <Link :href="'#'" class="hover:text-brand-400 transition-colors">Умови використання</Link>
                    </p>
...
const subscribeNewsletter = async () => {
    ...
    // TODO: підключити Inertia router.post(route('newsletter.subscribe'), { email })
    setTimeout(() => {
