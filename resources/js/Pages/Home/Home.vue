                ...
                <transition-group name="slide-fade">
                    ...
                    >
                        ...
                        <div class="relative grid grid-cols-1 lg:grid-cols-2 min-h-[400px] md:min-h-[480px]">
                            <!-- Контент -->
                            <div class="relative z-10 flex flex-col justify-center p-8 md:p-14 lg:p-16">
                                ...
                                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1] mb-4 tracking-tight drop-shadow-md animate-slide-up">
                                    {{ slide.titleLine1 }}<br>
                                    <span class="text-transparent bg-clip-text" :class="slide.titleAccent">{{ slide.titleLine2 }}</span>
                                </h1>

                                <p class="text-white/80 text-base sm:text-lg mb-8 max-w-md font-medium animate-slide-up-delayed">
                                    {{ slide.description }}
                                </p>

                                <div class="flex flex-wrap items-center gap-4 animate-slide-up-delayed-2">
                                    <Link :href="slide.ctaLink" class="relative inline-flex items-center justify-center h-14 px-8 text-base font-bold text-surface-950 bg-white rounded-2xl overflow-hidden group/btn hover:scale-105 transition-all shadow-[0_0_30px_rgba(255,255,255,0.2)]">
    ...
    <section class="container-app py-6">
        <div class="relative rounded-[2rem] overflow-hidden bg-gradient-to-r from-red-600 via-pink-600 to-orange-500 p-6 md:p-8 shadow-xl shadow-red-500/20">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <Link :href="route('products.index')" class="inline-flex items-center gap-2 h-12 px-6 bg-white text-red-600 rounded-xl font-bold hover:scale-105 transition-transform shadow-lg whitespace-nowrap">
                    Дивитись акції
    ...
    <section class="py-16" v-if="most_sold_in_store?.length">
        <div class="container-app">
            <div class="flex items-end justify-between mb-10">
                ...
                <Link :href="route('products.index')" class="hidden sm:flex items-center gap-2 px-6 py-3 rounded-xl bg-white/50 backdrop-blur border border-white/50 text-brand-600 font-bold hover:bg-white hover:shadow-lg transition-all group">
                    Всі товари
    ...
    <section class="py-12">
        <div class="container-app">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Link :href="route('products.index')" class="relative h-[300px] rounded-[2.5rem] overflow-hidden group shadow-xl">
    ...
    <section class="py-16 bg-white">
        <div class="container-app">
            <div class="flex items-end justify-between mb-10">
                ...
                <Link :href="'#'" class="hidden sm:flex items-center gap-2 px-6 py-3 rounded-xl border border-surface-200 text-surface-700 font-bold hover:bg-surface-50 transition-all group">
                    Всі статті
                    <i class="ri-arrow-right-line group-hover:translate-x-1 transition-transform"></i>
                </Link>
            </div>
...
const subscribeNewsletter = async () => {
    ...
    // TODO: підключити Inertia router.post('/newsletter', { email: newsletterEmail.value })
    setTimeout(() => {
