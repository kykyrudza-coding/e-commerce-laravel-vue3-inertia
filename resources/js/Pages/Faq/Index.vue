    ...
    <section class="pt-32 pb-20 relative z-20">
        <div class="container-app">
            ...
            <div class="mt-24 text-center max-w-2xl mx-auto animate-slide-up-delayed relative">
                ...
                <Link :href="route('contact')" class="h-16 px-10 inline-flex items-center justify-center gap-3 rounded-2xl bg-brand-600 text-white font-bold text-lg hover:bg-brand-700 hover:-translate-y-1 transition-all shadow-xl shadow-brand-500/30 group" id="faq-contact-btn">
                    Зв'язатися з нами
