        ...
        <div class="container-app relative z-10">
            <div class="flex h-9 items-center justify-between gap-4">
                ...
                <div class="hidden md:flex items-center gap-5 flex-shrink-0 font-medium">
                    <a to="tel:+380441234567" class="flex items-center gap-1.5 hover:text-amber-300 transition-colors">
        ...
        <div class="container-app relative">
            <div class="flex h-18 py-3 items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-8">
                    <!-- Лого з градієнтом -->
                    <RouterLink :to="route('home')" class="flex items-center gap-3 group flex-shrink-0">
                ...
                <div class="flex items-center gap-1.5 sm:gap-2">
                    ...
                    <RouterLink
                        v-if="auth?.user"
                        :to="route('cart.index', auth.user.id)"
...
import { useSearch } from '@/features/products/search-products'
import { SearchModal } from '@/features/products/search-products'
