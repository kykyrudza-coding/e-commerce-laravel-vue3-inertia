        ...
        <div class="w-full max-w-md animate-slide-up-delayed relative px-4 sm:px-0">
            ...
            <div class="bg-white/70 backdrop-blur-xl p-8 sm:p-10 rounded-[2.5rem] border border-white shadow-2xl shadow-brand-500/10 relative">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 text-surface-900 pl-4 flex items-center pointer-events-none">
                                <i class="ri-mail-line text-surface-900 group-focus-within:text-brand-500"></i>
                            </div>
                            <input
                                id="login-email"
                                v-model="form.email"
                ...
                <p class="mt-8 text-center text-sm font-medium text-surface-500">
                    Ще немає акаунту?
                    <RouterLink :to="route('register')" class="text-brand-600 font-bold hover:text-brand-700 ml-1 transition-colors">
                        Зареєструватись
                    </RouterLink>
                </p>
            </div>
