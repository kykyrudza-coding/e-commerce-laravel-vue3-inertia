...
import { ProgressBar, ProductBlock } from '@/widgets/checkout-flow';
import { ContactInfoForm } from '@/features/order/fill-contact-info';
import { AddAddress } from '@/features/order/add-address';
import { ConfirmOrder } from '@/features/order/confirm-order';
